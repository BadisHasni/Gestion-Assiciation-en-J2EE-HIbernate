...
<h3><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gestion des Rapports : <samp>  Page de remplisage d'un rapport</samp>
  ...
  <div class="col-md-6">
                ...
                <div class="panel panel-default">
						...
						<!--Formulaire d'ajout d'un Rapport**************************************************************************-->	 
							 ...
							 <form method="post" action="ServletChef">
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
																...
																<input  type="email" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="lastname" name="lieuchef" placeholder="Entrer Lieu de Mission">										
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
													...
													<div class="col-md-6">	
															 ...
															 <select id="disabledSelect" name="mission" class="form-control">
																<option  selected>--Choisir l'id d'une mission--</option>	
																	...
																	<c:forEach var="i" items="${tableau }">
																		<option name="mission" type="number" value="${i}"><c:out value="${i}"/></option>
																	</c:forEach>	
