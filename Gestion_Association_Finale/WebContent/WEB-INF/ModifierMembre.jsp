  ...
  <div class="col-md-6">
                ...
                <div class="panel panel-default">
						...
						<!--Formulaire d'ajout d'une mission**************************************************************************-->	 
							...
							<form method="post" action="Servlet_modifier_membre">
							        ...
							        <div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="firstname" name="nommembre" placeholder="Entrer le nom d'administrateur">							
									...
									<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="lastname" name="prenommembre" placeholder="Entrer le prenom d'administrateur">								
							 ...
							 <div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyNumber],length[0,3]] text-input" id="age" name="agemembre" placeholder="Entrer l'age de Membre">							
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
																...
																<input type="email" class="validate[required,custom[email]] text-input" id="email" name="mailmembre" placeholder="Entrer mail d'administrateur">										
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
