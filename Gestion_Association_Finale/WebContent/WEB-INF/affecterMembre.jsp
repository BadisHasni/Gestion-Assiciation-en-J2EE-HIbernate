...
<h3><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gestion des Missions: <samp>  Page d'affectation d'un Membre a une Mission</samp>
  ...
  <div class="col-md-6">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							<h4 id="titreformulaire"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Formulaire d'affectation d'un Membre a une Mission</strong> </h4>
						</div><!--panel-heading-->
						...
						<form method="post" action="Servlet_affecter_membre">
					...
					<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-3">
													    ...
													    <label for="exampleInputCatégorie"><strong>Membre :</strong></label>
													
													</div><!--col-md-3-->	
													<div class="col-md-6">	
													        	
															<select id="disabledSelect" name="membre" class="form-control">
																<option selected>--un Membre--</option>	
																
																<c:forEach var="i" begin="0" end="${tableau2.size()-1}">
																		<option name="membre" type="number" value="${tableau2[i].idMembre}"><c:out value="${tableau2[i].nom}"/></option>
																	</c:forEach>
									 ...
									 <div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input class="validate[required,custom[onlyLetter],length[0,100]] text-input"  type="text" name="durree"  id="firstname" placeholder="Entrer la durré de mission">							
