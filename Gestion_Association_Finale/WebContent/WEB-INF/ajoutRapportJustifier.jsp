...
<h3><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gestion des Rapports : <samp>  Page de remplisage d'un rapport Justifier.</samp>
  ...
  <div class="col-md-6">
                ...
                <div class="panel panel-default">
						...
						<!--Formulaire d'ajout d'un Rapport**************************************************************************-->	 
							 ...
							 <form method="post" action="Servlet_ajouter_rapport_justifier">
								...
								<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-3">
													    ...
													    <label for="exampleInputCatégorie"><strong>Justification:</strong></label>
													
													</div><!--col-md-3-->	
													<div class="col-md-6">	
													        							
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="firstname" name="justification" placeholder="Entrer des déponses ">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
