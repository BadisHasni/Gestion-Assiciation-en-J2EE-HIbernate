...
<h3><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gestion des Rapports : <samp>  Page de remplissage d'un rapport</samp>
...
<div class="col-md-3">         
          <a href="<c:url value="Servlet_ajouter_rapport_IA"/>" class="btn btn-warning" id="droite" >Ajout d'un rapport IA</a>
</div>

<div class="col-md-3">
         <a href="<c:url value="Servlet_ajouter_rapport_justifier"/>" class="btn btn-warning" id="droite" >Ajout d'un rapport Justifier</a>
</div>
