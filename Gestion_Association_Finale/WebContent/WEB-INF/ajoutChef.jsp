...
<h3><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gestion des Chef de groupe: <samp>  Page d'ajout d'un Chef</samp>
  ...
  <div class="col-md-6">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							<h4 id="titreformulaire"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Formulaire d'ajout d'un Chef de groupe</strong> </h4>
						</div><!--panel-heading-->
						...
						<!--Formulaire d'ajout d'une mission**************************************************************************-->	 
							...
							<form method="post" action="Servlet_ajouter_chef">
							        ...
							        <div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="firstname" name="nomchef" placeholder="Entrer le nom de Chef">							
									...
									<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="lastname" name="prenomchef" placeholder="Entrer le prenom de Chef">								
									 ...
									 <div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="number"  class="validate[optional,custom[noSpecialCaracters],length[0,20]]" id="user" name="agechef" placeholder="Entrer l'age de chef">							
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
																...
																<input type="email" class="validate[required,custom[email]] text-input" id="email" name="mailchef" placeholder="Entrer mail de chef">										
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<h4><strong>M :
																<input class="validate[required] radio" id="radio1" type="radio" name="civilité" value="M"> 
																		F :	  
																<input class="validate[required] radio" id="radio2" type="radio" name="civilité" value="F">
															</h4></strong>	
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="number" class="validate[required,custom[onlyNumber],length[0,10]] text-input" id="email2" name="numchef" placeholder="Entrer le numéro">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="number" class="validate[required,custom[onlyNumber],length[0,10]] text-input" id="age" name="codechef" placeholder="Entrer le code Postale">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
