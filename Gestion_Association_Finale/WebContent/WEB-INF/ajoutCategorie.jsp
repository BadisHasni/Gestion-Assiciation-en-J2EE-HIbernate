...
<h3><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gestion des Missions: <samp>  Page d'ajout d'une Catégorie</samp>
  ...
  <div class="col-md-6">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							<h4 id="titreformulaire"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Formulaire d'ajout d'une Catégorie</strong> </h4>
						</div><!--panel-heading-->
						...
						<form method="post" action="Servlet_ajouter_categorie">
							        ...
							        <div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" name="nomcat" id="firstname" placeholder="Entrer le nom de Catégorie">							
							...
							<h6 id="astuce"><strong>Astuce:</strong>  Une categorie avec une tous les champs remplis 7 fois plus efficace ! .</h6>
