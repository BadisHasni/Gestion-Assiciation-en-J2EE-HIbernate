...
<h3><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gestion des Rapports : <samp>  Page de remplisage d'un rapport par l'intermédiaire d'un admin</samp>
  ...
  <div class="col-md-6">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							<h4 id="titreformulaire"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Formulaire d'ajout d'un rapport pour une Mission</strong> </h4>
						</div><!--panel-heading-->
						
						<!--Contenu-->
						<div class="panel-body">								 
						<!--Formulaire d'ajout d'un Rapport**************************************************************************-->	 
															 
							 <form method="post" action="Servlet_ajouter_rapport_IA">
								...
								<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-3">
													    ...
													    <label for="exampleInputCatégorie"><strong>Remarque Admin:</strong></label>
													
													</div><!--col-md-3-->	
													<div class="col-md-6">	
													        							
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="firstname" name="Rqadmin" placeholder="Entrer des déponses ">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
											...
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															 ...
															 <select id="disabledSelect" name="mission" class="form-control">
																<option  selected>--Choisir l'id d'une mission--</option>	
							...
							<h6 id="astuce"><strong>Astuce:</strong>  Un rapport avec tous les champs remplis 7 fois plus efficace ! .</h6>
