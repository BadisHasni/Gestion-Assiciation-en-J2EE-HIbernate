...
<h3><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gestion des Membres: <samp>  Page d'ajout d'un Membre</samp>
  ...
  <div class="col-md-6">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							<h4 id="titreformulaire"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Formulaire d'ajout d'un Membre</strong> </h4>
						</div><!--panel-heading-->
						...
						<!--Formulaire d'ajout d'une mission**************************************************************************-->	 
							...
							<form method="post" action="Servlet_ajouter_membre">
							        ...
							        <div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="firstname" name="nommembre" placeholder="Entrer le nom de Membre">							
									...
									<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="lastname" name="prenommembre" placeholder="Entrer le prenom de Membre">								
									 ...
									 <div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="number" class="validate[required,custom[onlyNumber],length[0,3]] text-input" id="age" name="agemembre" placeholder="Entrer l'age de Membre">							
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
																...
																<input type="email" class="validate[required,custom[email]] text-input" id="email" name="mailmembre" placeholder="Entrer mail de Membre">										
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required]" id="date" name="datemembre" placeholder="Entrer Date de Naissance">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required]" id="user" name="loginmembre" placeholder="Entrer un Login">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="password" class="validate[required,length[6,11]] text-input" id="password" name="pwdmembre" placeholder="Entrer votre mot de passe">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<h6 id="astuce"><strong>Astuce:</strong>  Un Membre avec une tous les champs remplis 7 fois plus efficace ! .</h6>
