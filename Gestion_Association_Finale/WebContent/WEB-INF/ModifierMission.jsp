...
<h3><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gestion des Missions: <samp>  Page de Modification d'une mission</samp>
  ...
  <div class="col-md-6">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							<h4 id="titreformulaire"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Formulaire de modification d'une Mission</strong> </h4>
						</div><!--panel-heading-->
						...
						<!--Formulaire d'ajout d'une mission**************************************************************************-->	 
							...
							<form method="Post" action="Servlet_modifier_mission">
							        ...
							        <div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="firstname" name="nommission" placeholder="Entrer le nom d'administrateur">							
									...
									<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,length[6,300]] text-input" id="comments" name="descmission" placeholder="Entrer une description">								
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
																...
																<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="lastname" name="lieumission"  placeholder="Entrer le lieu de mission">										
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required]" id="date" name="datemission" placeholder="Entrer Date de Mission">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyNumber],length[0,10]] text-input" id="age" name="budgetmission" placeholder="Entrer le budget">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
