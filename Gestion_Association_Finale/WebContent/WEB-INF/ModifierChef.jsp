  ...
  <div class="col-md-6">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							<h4 id="titreformulaire"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Formulaire de Modification d'un Chef de Groupe</strong> </h4>
						</div><!--panel-heading-->
						
						<!--Contenu-->
						<div class="panel-body">								 
						<!--Formulaire d'ajout d'un chef**************************************************************************-->	 
															 
							<form method="post" action="Servlet_modifier_chef">
							        ...
							        <div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="firstname" name="nomchef" placeholder="Entrer le nom d'administrateur">							
									...
									<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required,custom[onlyLetter],length[0,100]] text-input" id="lastname" name="prenomchef" placeholder="Entrer le prenom d'administrateur">								
									 ...
									 <div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-3">
													    ...
													    <label for="exampleInputCatégorie"><strong>Age :</strong></label>
													
													</div><!--col-md-3-->	
													<div class="col-md-6">	
													        	
															<input type="text"  class="validate[optional,custom[noSpecialCaracters],length[0,20]]" id="user" name="agechef" placeholder="Entrer l'age de chef">							
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
																...
																<input type="email" class="validate[required,custom[email]] text-input" id="email" name="mailchef" placeholder="Entrer mail d'administrateur">										
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required]" id="date" name="datechef" placeholder="Entrer Date de Naissance">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="text" class="validate[required]" id="password2" name="loginchef" placeholder="Entrer un Login">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-6">	
															...
															<input type="password" class="validate[required,length[6,11]] text-input" id="password" name="pwdchef" placeholder="Entrer votre mot de passe">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
									...
									<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-3">
													    ...
													    <label for="exampleInputCatégorie"><strong>Civilité :</strong></label>
													
													</div><!--col-md-3-->	
													<div class="col-md-6">	
													        							
															<h4><strong>M :
																<input class="validate[required] radio" id="radio1" type="radio" name="civilité" value="option1">
																		F :	  
																<input class="validate[required] radio" id="radio2" type="radio" name="civilité" value="option1">
															</h4></strong>	
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-3">
													    ...
													    <label for="exampleInputCatégorie"><strong>Rue :</strong></label>
													
													</div><!--col-md-3-->	
													<div class="col-md-6">	
													        							
															<input type="text" class="validate[required]" id="user" name="ruechef" placeholder="Entrer le nom de la rue">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-3">
													    ...
													    <label for="exampleInputCatégorie"><strong>Numéro :</strong></label>
													
													</div><!--col-md-3-->	
													<div class="col-md-6">	
													        							
															<input type="text" class="validate[required,custom[onlyNumber],length[0,10]] text-input" id="email2" name="numchef" placeholder="Entrer le numéro">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<div class="row">
											<div class="form-group" id="formul1">
													...
													<div class="col-md-3">
													    ...
													    <label for="exampleInputCatégorie"><strong>Code Postal :</strong></label>
													
													</div><!--col-md-3-->	
													<div class="col-md-6">	
													        							
															<input type="text" class="validate[required,custom[onlyNumber],length[0,10]] text-input" id="age"  name="codechef" placeholder="Entrer le code Postale">												
													</div><!--col-md-6-->
													<div class="col-md-2"></div><!--col-md-2-->
													</div><!--form-group-->
							...
							<h6 id="astuce"><strong>Astuce:</strong>  Un chef avec une tous les champs remplis 7 fois plus efficace ! .</h6>
