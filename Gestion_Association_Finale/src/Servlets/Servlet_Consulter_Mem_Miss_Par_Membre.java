...
@WebServlet("/Servlet_consulter_mem_miss_par_membre")
public class Servlet_Consulter_Mem_Miss_Par_Membre extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
       Mission_MembreService mim = new Mission_MembreService();
       
    public Servlet_Consulter_Mem_Miss_Par_Membre() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// liste des Mission_Membre
 		...
 		this.getServletContext().getRequestDispatcher("/WEB-INF/ConsulterMissionMembreParMembre.jsp").forward( request, response );
